          ...
          <div class="container px-lg-5">
            ...
            <div class="row gx-lg-5">
              <div class="col-lg-6 col-xxl-4 mb-5">
                <form class="form-horizontal" method="POST" action="put-tabela.php">
                  <input type="hidden" id="id" name="id" value="<?php echo $tabela->getId(); ?>">
                  <div class="row">
                    <div class="form-group">
                      <label class="control-label" for="nome">Nome:</label><br>
                      <div class="col-lg-12">
                        <input class="form-control" type="text" id="nome" name="nome" value="<?php echo $tabela->getNome(); ?>">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label" for="descricao">Descrição:</label><br>
                      <div class="col-lg-12">
                        <textarea class="form-control" id="descricao" name="descricao" rows="4"><?php echo $tabela->getDescricao(); ?></textarea>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label" for="pontuacao">Pontuação:</label><br>
                      <div class="col-lg-12">
                        <input type="number" class="form-control" id="pontuacao" name="pontuacao" value="<?php echo $tabela->getPontuacao(); ?>">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label" for="regra_pontuacao">Regra de Pontuação:</label><br>
                      <div class="col-lg-12">
                        <textarea class="form-control" id="regra_pontuacao" name="regra_pontuacao" rows="4"><?php echo $tabela->getRegra(); ?></textarea>
                      </div>
                    </div>
                    <div class="form-group">
