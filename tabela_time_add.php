<?php
  ...
  $time= new Time;
  $Xtimes = $time->getAllTimesNotTabela($tabela->getId());
?>
<!DOCTYPE html>
<html lang="pt">
    <head>
    ...
    <body>
        ...
        <header class="py-5">
          <div class="container px-lg-5">
            <h2>Novo Time Tabela <?php echo $tabela->getNome(); ?></h2>
          </div>
        </header>
        <!-- Page Content-->
        <section class="pt-4">
          <div class="container px-lg-5">
            ...
            <div class="row gx-lg-5">
              <div class="col-lg-6 col-xxl-4 mb-5">
                <form class="form-horizontal" method="POST" action="post-tabela_time.php">
                  <input type="hidden" id="idTabela" name="idTabela" value="<?php echo $tabela->getId(); ?>">
                  <div class="row">
                    <div class="form-group">
                      <label class="control-label" for="idTime">Time:</label><br>
                      <div class="col-lg-12">
                        <select class="form-control" id="idTime" name="idTime">
                          <?php
