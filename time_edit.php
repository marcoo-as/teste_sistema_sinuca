          ...
          <div class="container px-lg-5">
            ...
            <div class="row gx-lg-5">
              <div class="col-lg-6 col-xxl-4 mb-5">
                <form class="form-horizontal" method="POST" action="put-time.php">
                  <input type="hidden" id="id" name="id" value="<?php echo $time->getId(); ?>">
                  <div class="row">
                    <div class="form-group">
                      <label class="control-label" for="nome">Nome:</label><br>
                      <div class="col-lg-12">
                        <input class="form-control" type="text" id="nome" name="nome" value="<?php echo $time->getNome(); ?>"><br>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label" for="jogador1">Jogador 1:</label><br>
                      <div class="col-lg-12">
                        <input class="form-control" type="text" id="jogador1" name="jogador1" value="<?php echo $time->getJogador1(); ?>"><br>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label" for="jogador2">Jogador 2:</label><br>
                      <div class="col-lg-12">
                        <input class="form-control" type="text" id="jogador2" name="jogador2" value="<?php echo $time->getJogador2(); ?>"><br>
                      </div>
                    </div>
                    <div class="form-group">
